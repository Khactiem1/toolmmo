<template>
    <div class="container-table">
        ...
        <ms-grid-viewer :ref="viewRef" :data="storeModule.items" :pageTotal="storeModule.total"
            :loading="storeModule.loading" :idField="'message_id'" :gridInfo="gridInfo" :loadData="loadData"
...
export default defineComponent({
    ...
    setup: () => {
        ...
        const layoutTag = ref("ChatsList"); // Cấu hình layout
        const formDetailName = ref("ChatsDetail"); // Cấu hình tên form detail
